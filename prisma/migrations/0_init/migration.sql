...
-- AddForeignKey
ALTER TABLE "booking" ADD CONSTRAINT "booking_booking_manager_id_fkey" FOREIGN KEY ("booking_manager_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "service" ADD CONSTRAINT "service_booking_id_fkey" FOREIGN KEY ("booking_id") REFERENCES "booking"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
