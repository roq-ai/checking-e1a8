...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['agency-employee', 'property-owner', 'booking-manager'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Property', path: '/properties', entity: 'property', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Service', path: '/services', entity: 'service', service: AccessServiceEnum.PROJECT, icon: FiBox },
